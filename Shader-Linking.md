...
Prior to linking, the vertex export is being squeezed. For instance, if vertex program writes to the exports 2, 7 and 9, they will be remapped as 2 -> 0, 7 -> 1, 9 -> 2; the linker will see them as 0, 1 and 2 exports.
