...
| 0x500 .. 0x540 | PSEQ      | (Program Sequencer) control pixel pipeline flow  |
...
| 0xA00 .. 0xA0B | FDC       | configure and control (flush to DRAM)<br>unified memory cache used by QRast, PSEQ, DW |
| 0xB00 .. 0xB01 | GSHIM     | ???                    |
